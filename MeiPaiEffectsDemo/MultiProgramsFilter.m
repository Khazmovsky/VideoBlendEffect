...
NSString *const kMyGPUImageVertexShaderString = SHADER_STRING
(
...
NSString *const kMyGPUImagePassthroughFragmentShaderString = SHADER_STRING
(
...
static void dataProviderUnlockCallback (void *info, const void *data, size_t size);

@interface MultiProgramsFilter ()
@property (readwrite, nonatomic) CGFloat aspectRatio;

@end

@implementation MultiProgramsFilter
...
- (id)initWithVertexShaderFromString:(NSString *)vertexShaderString fragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    runSynchronouslyOnVideoProcessingQueue(^{
        ...
        [self setFloat:0.05 forUniform:fractionalWidthOfAPixelUniform program:filterProgram];
...
{
    if (!(self = [self initWithVertexShaderFromString:kMyGPUImageVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
		return nil;
    }
...
- (id)init;
{
    if (!(self = [self initWithFragmentShaderFromString:kMyGPUImagePassthroughFragmentShaderString]))
    {
		return nil;
    }
...
{
    MultiProgramsFilter *filter = (__bridge_transfer MultiProgramsFilter*)info;
...
- (void)setupProgram2VertexShaderString:(NSString *)vertexShaderString fragmentShaderString:(NSString *)fragmentShaderString {
    runSynchronouslyOnVideoProcessingQueue(^{
        ...
        filterProgram2 = [[GPUImageContext sharedImageProcessingContext] programForVertexShaderString:vertexShaderString fragmentShaderString:fragmentShaderString];
        ...
        filterPositionAttribute2 = [filterProgram2 attributeIndex:@"position"];
        filterTextureCoordinateAttribute2 = [filterProgram2 attributeIndex:@"inputTextureCoordinate"];
        filterInputTextureUniform2 = [filterProgram2 uniformIndex:@"inputImageTexture"]; // This does assume a name of "inputImageTexture" for the fragment shader
        
        [GPUImageContext setActiveShaderProgram:filterProgram2];
        
        glEnableVertexAttribArray(filterPositionAttribute2);
...
//    _vignetteStart = newValue;
    ...
    [self setFloat:newValue forUniform:vignetteStartUniform program:filterProgram];
}
...
//    _vignetteEnd = newValue;
    ...
    [self setFloat:newValue forUniform:vignetteEndUniform program:filterProgram];
}

- (void)use2 :(NSString *)v :(NSString *)f {
    [GPUImageContext useImageProcessingContext];
    
    filterProgram2 = [[GPUImageContext sharedImageProcessingContext] programForVertexShaderString:v fragmentShaderString:f];
